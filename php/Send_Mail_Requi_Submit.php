...
try {
    ...
    $html_file='http://mjge.in/account/template/requisition.php?receipt_no='.$receipt_no;
	...
	$mail->AddReplyTo("technical@mjge.in","Requisition by ".$user_name);

	$mail->From       = "technical@mjge.in";
	$mail->FromName   = "Requisition by ".$user_name;
...
while ($row=$result->fetch_assoc()) 
{
	...
	$mail->Subject  = "Requisition by ".$user_name;

	$mail->AltBody    = "<b>Requisition by $user_name :<b><br><br>
	<b>". $title."</b> </br>
	<p>".$description."</p> <br>
	<p>".$category."</p> <br>
