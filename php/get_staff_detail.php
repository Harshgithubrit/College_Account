...
if (isset($_REQUEST['page_no']) && $_REQUEST['page_no']!="") {
 ...
 $query ="select * from employee where  staff_type LIKE '%$staffTYPE%' and (employee_name  LIKE '%$ser%' or employee_id LIKE '%$ser%' )  and college_name LIKE '%$clg_name%' order by id DESC";
    //  $query="SELECT * FROM `employee` where college_name='$clg_name' and staff_type='$staffTYPE' and status='1' ";

   // $query= "select * from mj where user_id LIKE '%$ser%' OR fullname LIKE '%$ser%' order by id DESC " ; 
    
    

   $Total_record_query="SELECT COUNT(*) As total_records FROM `employee` where  staff_type LIKE '%$staffTYPE%' and (employee_name  LIKE '%$ser%' or employee_id LIKE '%$ser%')  and college_name LIKE '%$clg_name%' order by id DESC ";
