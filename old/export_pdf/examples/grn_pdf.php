...
$receipt_no = $_REQUEST["receipt_no"];
 ...
 $query_= "select * from account_purchase_order where receipt_no = '$receipt_no'  ";
  ...
  if($result_->num_rows > 0) {
    ...
    $delivery_date = $row_["delivery_date"] ;   
    $vendor_receipt_no = $row_["vendor_receipt_no"] ;   
    $vendor_name = $row_["vendor_name"] ;   
      }
    }
    ...
    $total=0;
     ...
     $query_i="select * from account_purchase_order_item where receipt_no = '$receipt_no'  ";
  ...
  if($result_i->num_rows > 0) {
    ...
    $total =$total +  ($row_i["price"]*$row_i["delivered_quantity"]);
    ...
    <tr class="item">
            <td> '.$row_i["item"].' </td>
            <td>'. $row_i["price"].'</td>
            <td>'. $row_i["delivered_quantity"].'</td>
            <td class="text-align-right">'. ($row_i["price"]*$row_i["delivered_quantity"]).'</td>
            </tr>
...
<tr class="heading" >
     ...
     <b>Vendor Receipt No:-</b>$vendor_receipt_no<br>
     </td>
     <td width="35%">
