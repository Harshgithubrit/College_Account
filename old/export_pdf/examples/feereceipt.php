...
function displaywords($number){
  ...
  $query_="select * from college_fee as f join college as c on c.college_id = f.college_id join student_course_applied as z on f.student_id = z.student_id where f.student_id = '$student_id' and z.pursuing_passed = 'Pursuing' and f.receipt_no= '$receipt_id' and f.id = $rid ";
