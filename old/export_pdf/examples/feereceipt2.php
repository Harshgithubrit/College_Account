...
function displaywords($number){
  ...
  if($result_->num_rows > 0) {
    ...
    $cheque_dd_no =  $row_["cheque_dd_no"];
     ...
     $query1="select * from college_fee_instalment where id='$id' And receipt_no='$receipt_id' ";

    
     $result1_ = $mysqli->query($query1) or die($mysqli->error.__LINE__);
     
   
     
      if($result1_->num_rows > 0) {
    while($row_ = $result1_->fetch_assoc()) {
    ...
    $payment_type =  $row_["payment_type"];
     
    $cheque_no =  $row_["cheque_no"];
      
    $cheque_date =  $row_["cheque_date"];
       
    $transaction_id =  $row_["transaction_id"];
...
*/
 $pay_in_words=displaywords($amount);
  $Remaining_amount=$total_fee-$amount;
...
<div style="background-image: url("http://mjge.in/account/images/logo.png"); justify-content:center !important; heigth:100%; width: 100%; opacity:0.2;"></div>
...
<tr style="width: 100%;" >
    ...
    <p><br></p>
    <p> Receipt No.<b>  $receipt_id/$receipt_id2 </b> </p>
    <p><b> Date.   $date </b> </p>
    </th>
  </tr>
...
-moz-border-radius:6px;">
  ...
  <th></th>
	<th>Pay Amount</th>
	<th style="text-align:left;">$amount Rs.</th>
  </tr>
...
<table border="0.1"  style="width:100%"> 
  <tr>
  <th>(in Words Rs.) <i>$pay_in_words</i> </th>
  </tr>
</table>
<p><br></p>
<table style= "
...
-moz-border-radius:6px;">
  ...
  <tr>
    <td>By Ch. No./Dd No. $cheque_no </td>
    <td> Cheque Date $cheque_date </td>
  </tr>
