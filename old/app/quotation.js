...
//alert("oo");
    ...
    var query=" select  vendor_id, vendor_name, mobile, email, user_name, user_id, date, time, remarks, category, priority, receipt_no, admin_approved, admin_remarks from account_quotation where account_approved='Approved'  group by receipt_no order by id DESC ";
...
// if(result.data['0'].status == "1") {
 ...
 dialog_for_create_quotation(receipt_no_last, $scope.approve_remarks, remarks_status,user_full_name);
...
function dialog_for_create_quotation(receipt_no_last, approve_remarks, remarks_status,user_full_name){
    
    
  console.log(receipt_no_last);
       
 $http.post("php/Approve_create_po.php?receipt_no="+receipt_no_last+"&approve_remarks="+approve_remarks+"&remarks_status="+remarks_status+"&user_full_name="+user_full_name)
 .then(function (result) {
  console.log(result.data);
if(result.data['0'].status == "1") {
