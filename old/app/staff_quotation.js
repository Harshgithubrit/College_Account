...
var query=" select  vendor_id, vendor_name, mobile, email, user_name, user_id, date, time, remarks, category, priority, receipt_no, admin_approved, (select account_requisition.admin_remarks from account_requisition where account_requisition.receipt_no = a.receipt_no) as admin_remarks from account_quotation as a  group by a.receipt_no order by a.id DESC ";
...
{
var method="update";
var query ="update account_requisition set hold_status='3' where receipt_no='"+receipt_no_last+"'";
...
$scope.submit_Rq= function(){
  ...
  .then((willDelete) => {
    ...
    var  query = "update `account_quotation` set  account_approved='Approved', submitted ='YES', vendor_id ='"+vendor_gen_id+"',  vendor_name ='"+$scope.to_vandor+"',account_approved_by='"+EMP_id+"' where receipt_no='"+receipt_no_last+"' ";
