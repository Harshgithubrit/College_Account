...
$query ="select  *  from account_purchase_order join account_vendor on account_vendor.vendor_id= account_purchase_order.vendor_id where account_purchase_order.receipt_no = '$receipt_no'  ";
...
while ($row=$result->fetch_assoc()) 
{
    ...
    $vendor_receipt_no=$row['vendor_receipt_no'];
}
...
<body >
    <div style="background-color: #fffce6;" class="invoice-box">
        <table>
            <tr>
                <td width="20%">
                ...
                <td width="80%">
                    Purchase-Order No : <b>PO-<?php echo $receipt_no;?></b><br>
      ...
      <b> Purpose</b>:<?php echo $perpose;?>
            ...
            <td>
                <b> Vendor Serial No</b>:<?php echo $vendor_receipt_no;?>
            </td>
...
<tr>
             ...
             <td><b>Delivery Date</b><?php echo $delivery_date;?> </td>
...
';
    ...
    <button style="background-color: #0052b0; height:50px; border-radius: 12px; padding: 10px; text-align:center; text-decoration: none; cursor: pointer; 
    display: inline-block; justify-content: right; align-items: right; position: absolute; right: 18%;"><a style="color: white;" href="http://mjge.in/account">Approve/Disapprove</a></button>
