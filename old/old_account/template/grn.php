...
<body >
    <div style="background-color: #ffeded;" class="invoice-box">
        <table>
            <tr>
                ...
                <td width="80%">
                    GRN Number: <b>RN-<?php echo $receipt_no;?></b><br>
 ...
 <table>
<tr>
 <td> <div style="border-style: solid; border-width: 2px";> <center><h1>Goods/Services Recevied Note</h1></center>  </div></td>
</tr></table>
        
	
        <table>
            <tr style="width:100%">
                <td width="50%">   <p style=" text-align:left"><b> TO:</b></p>
                   <b> Order No :-</b> <?php echo $user_name;?> <br>
