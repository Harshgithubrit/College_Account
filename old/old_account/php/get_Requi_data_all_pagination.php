...
$resulti = $mysqli->query($queryi) or die($mysqli->error.__LINE__);
       ...
       $arr[] =array('delivered_status'=>$delivered_status, 'verify_status'=>$verify_status_approved,'q_approved'=> $qadmin_approved,'p_approved'=> $padmin_approved,'quantity'=> $quantity, 'total'=> $total, 'mobile'=> $row["mobile"], 'email'=> $row["email"], 'user_name'=> $row["user_name"], 'user_id'=> $row["user_id"], 'date'=> $row["date"], 'time'=> $row["time"], 'remarks'=> $row["remarks"], 'category'=> $row["category"], 'priority'=> $row["priority"], 'receipt_no'=> $row["receipt_no"], 'admin_approved'=> $row["admin_approved"], 'admin_remarks'=> $row["admin_remarks"]);
