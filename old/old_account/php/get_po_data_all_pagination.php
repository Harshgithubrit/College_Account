...
$resulti = $mysqli->query($queryi) or die($mysqli->error.__LINE__);
        ...
        $arr[] =array('vendor_id'=> $row["vendor_id"], 'vendor_name'=> $row["vendor_name"], 'quantity'=> $quantity, 'total'=> $total,'delivery_date'=>$row["delivery_date"],'mobile'=> $row["mobile"], 'email'=> $row["email"], 'user_name'=> $row["user_name"], 'user_id'=> $row["user_id"], 'date'=> $row["date"], 'time'=> $row["time"], 'remarks'=> $row["remarks"], 'category'=> $row["category"], 'priority'=> $row["priority"], 'receipt_no'=> $row["receipt_no"], 'admin_approved'=> $row["admin_approved"],'delivery_date'=>$row["delivery_date"], 'admin_remarks'=> $row["admin_remarks"]);
