...
if($result1->num_rows > 0) {
    ...
    $arr[] =array('status' => '0', 'message' => 'receipt number alredy exist!');
...
if($result1->num_rows > 0) {
    ...
    $arr[] =array('status' => '0', 'message' => 'Student Fee alredy full paid!');
    echo $json_response =json_encode($arr);
