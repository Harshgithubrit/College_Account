...
//   $http.post("php/get_Requi_data.php?uid="+EMP_id)
//       .then(function (result) {
//       // console.log(result.data);
...
var query=" select mobile, email, user_name, user_id, date, time, remarks, category, priority, receipt_no, admin_approved, admin_remarks from account_requisition as a  where  a.user_id='"+EMP_id+"' group by a.receipt_no order by a.id DESC ";
  var Total_record_query="SELECT COUNT(*) As total_records FROM `account_requisition` where  user_id='"+EMP_id+"'  ";
...
$scope.callList= function(index){
  ...
  $scope.Requisition_data = function (index) {
    ...
    //console.log($scope.Requi_details[index].category);
...
$scope.preview_pdf = function(){ 
  ...
  //  alert(receipt_pdf_id);    
       window.open('template/staff_requisition_receipt.php?receipt_no='+receipt_no_last,'_blank');
...
swal.close();
 ...
 $scope.Requisition_Dete = function (index) {
  ...
  .then((willDelete) => {
    ...
    var  query = " delete from `account_requisition_item` where receipt_no='"+$scope.Requi_item_details[index].receipt_no+"' and  id="+$scope.Requi_item_details[index].id+" ";
...
$scope.approve_data= function(){
  ...
  var query="update account_requisition set admin_remarks='"+$scope.approve_remarks+"', admin_approved='"+remarks_status+"' where receipt_no='"+receipt_no_last+"' ";
...
$scope.submit_Rq= function(){
  ...
  .then((willDelete) => {
    ...
    var  query = " update `account_requisition` set submitted ='YES', account_approved_by='"+EMP_id+"' where receipt_no='"+receipt_no_last+"' and  user_id='"+EMP_id+"' ";
  ...
  .then(function (result) {
   ...
   if(result.data.success==true){
       ...
       $http.post("php/Send_Mail_Requi_Submit.php?receipt_no="+receipt_no_last)
  .then(function (result) {
    console.log(result);
  }, function(result) {
      console.log(result);
...
$scope.user_full_name= user_full_name;
...
$scope.GOBACK = function(){
    ...
    console.log(profile_type);
       ...
       } else if(result.data.ctype =="Staff" ) {
            window.opener = self;
    window.close();
