...
var query=" select  vendor_id, vendor_name, mobile, email, user_name, user_id, date, time, remarks, category, priority, receipt_no, admin_approved, admin_remarks from account_quotation as a group by a.receipt_no order by a.id DESC ";
...
var data=JSON.stringify($scope.cars);
     ...
     $http.post("php/Send_mail_vendors.php?data="+data+"&receipt_no="+receipt_no_last)
         .then(function (result) {
