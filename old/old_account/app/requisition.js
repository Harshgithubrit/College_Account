...
var query=" select mobile, email, user_name, user_id, date, time, remarks, category, priority, receipt_no, admin_approved, admin_remarks from account_requisition as a   group by a.receipt_no order by a.id DESC ";
...
$scope.approve_data= function(){
  ...
  var query="update account_requisition set admin_remarks='"+$scope.approve_remarks+"', admin_approved='"+remarks_status+"', admin_approved_by ='"+EMP_id+"' where receipt_no='"+receipt_no_last+"' ";
