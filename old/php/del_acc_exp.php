...
$mysqli->set_charset("utf8");
 ...
 $query = " delete from `account_expenses_item` where user_id='$user_id' and receipt_no='$receipt_no' ";
$query1 = " delete from `account_expenses` where user_id='$user_id' and receipt_no='$receipt_no' ";
