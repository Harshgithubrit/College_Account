...
$resulti = $mysqli->query($queryi) or die($mysqli->error.__LINE__);
	    	while($rowi = $resulti->fetch_assoc()) {
	    	     ...
	    	     $total=$rowi["total"];
	    	     $delivered_quantity=$rowi["delivered_quantity"];
	    	}
	    
        $arr[] =array('vendor_receipt_file'=> $row["vendor_receipt_file"],'vendor_receipt_no'=> $row["vendor_receipt_no"],'delivered_quantity' => $delivered_quantity, 'verify_status'=> $row["verify_status"], 'vendor_id'=> $row["vendor_id"], 'vendor_name'=> $row["vendor_name"], 'quantity'=> $quantity, 'total'=> $total, 'mobile'=> $row["mobile"], 'email'=> $row["email"], 'user_name'=> $row["user_name"], 'user_id'=> $row["user_id"], 'date'=> $row["date"], 'time'=> $row["time"], 'remarks'=> $row["remarks"], 'category'=> $row["category"], 'priority'=> $row["priority"], 'receipt_no'=> $row["receipt_no"], 'admin_approved'=> $row["admin_approved"], 'admin_remarks'=> $row["admin_remarks"]);
