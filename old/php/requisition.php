...
$queryUpdater=" update `account_requisition` set `user_name`='$user_full_name', `create_date`='$requisition_date', `email`='$email', `mobile`='$phone',  `remarks`='$description', `category`='$category', `priority`='$priority' where receipt_no='$receipt_no' ";
