...
//   $http.post("php/get_Quot_data_all.php?uid="+EMP_id)
//       .then(function (result) {
//       // console.log(result.data);
...
var query=" select  *, (select account_requisition.admin_remarks from account_requisition where account_requisition.receipt_no = a.receipt_no) as admin_remarks, (select account_requisition.hold_status from account_requisition where account_requisition.receipt_no = a.receipt_no) as hold_status, (select account_requisition.hold_date from account_requisition where account_requisition.receipt_no = a.receipt_no) as hold_date from account_quotation as a group by a.receipt_no order by a.id DESC ";
...
$scope.preview_pdf = function(){ 
  ...
  //  alert(receipt_pdf_id);    
       window.open('template/Staff_Quotation_receipt.php?receipt_no='+receipt_no_last,'_blank');
...
$scope.submit_Rq= function(){
  ...
  .then((willDelete) => {
    ...
    var  query = "update `account_quotation` set submitted ='YES', vendor_id ='"+vendor_gen_id+"', vendor_name ='"+$scope.to_vandor+"',account_approved_by='"+EMP_id+"' where receipt_no='"+receipt_no_last+"'  ";
  ...
  .then(function (result) {
   ...
   if(result.data.success==true){
       ...
       var  query1 = "update `account_requisition` set account_approved_by='"+EMP_id+"',hold_status = '3',hold_date='"+dates+"' where receipt_no='"+receipt_no_last+"'";
       console.log(query1);
       $http.post("php/API.php?query="+query1+"&method="+method)
        .then(function (result) {
          console.log(result);
        }, function(result) {
            console.log(result);
