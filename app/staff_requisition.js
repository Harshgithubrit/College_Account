...
var query=" select * from account_requisition where  user_id='"+EMP_id+"' group by receipt_no order by id DESC ";
...
$scope.submit_Rq= function(){
  ...
  .then((willDelete) => {
    ...
    var  query = " update `account_requisition` set submitted ='YES', hold_status='1', admin_remarks='', account_approved_by='"+EMP_id+"' where receipt_no='"+receipt_no_last+"' and  user_id='"+EMP_id+"' ";
