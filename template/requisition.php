...
<body >
    <div style="background-color: #edf8ff;" class="invoice-box">
        <table>
            <tr>
                <td width="20%">
                ...
                <td width="80%">
                    Requisition No : <b>RN-<?php echo $receipt_no;?></b><br>
      ...
      <b> Purpose</b>:<?php echo $perpose;?>
        ...
        <table style="width:100%; " >
            ...
            <table style="width:100%;">
                ...
                $query ="select  *  from account_requisition_item where receipt_no = '$receipt_no' ";
